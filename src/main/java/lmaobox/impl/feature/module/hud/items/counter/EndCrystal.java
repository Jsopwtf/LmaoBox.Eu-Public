...
public class EndCrystal extends HudElement {
    ...
    public EndCrystal(HUD hud) {
        super(hud, "end-crystals-counter", "displays the amount of crystals in your inventory.", false);
    }
